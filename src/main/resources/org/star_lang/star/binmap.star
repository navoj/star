...
private findNode has type (binmap of (%k,%v),%k)=> Maybe of %v where comparable over %k 'n equality over %k;
...
private insertNode has type (binmap of (%k,%v),%k,%v) => binmap of (%k,%v) where comparable over %k 'n equality over %k;
...
private mergeNodes has type (binmap of (%k,%v),binmap of (%k,%v))=>binmap of (%k,%v) where comparable over %k 'n equality over %k;
...
implementation pPrint over binmap of (%k,%v) where pPrint over %k 'n pPrint over %v is {
...
implementation sequence over binmap of (%k,%v) determines ((%k,%v)) where equality over %k 'n comparable over %k is {
...
implementation updateable over binmap of (%k,%v) determines ((%k,%v)) where equality over %k'n comparable over %k is {
