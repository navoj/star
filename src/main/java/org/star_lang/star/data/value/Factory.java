...
public class Factory {
   ...
   *
   * @param cxt  The type context to use for resolving the code references for the anonymous record.
   * @param args An alternating sequence of string labels and IValue elements.
   ...
   *
   * @param type     the type description for the type of the new value.
   * @param label    the label corresponding to the particular constructor function to use in building the
   *                 value. This label must be known to the type description that is in {@code type}.
   * @param elements the elements, in order, of the constructor function. If this method is used to
   ...
   * @throws EvaluationException if there is a problem in creating the value
   */
   ...
   *
   * @param cxt      the type context in which to find the description of the type
   * @param typeName the name of the type. Note: only non-polymorphic types may be instantiated using this
   *                 function.
   * @param label    the label corresponding to the particular constructor function to use in building the
