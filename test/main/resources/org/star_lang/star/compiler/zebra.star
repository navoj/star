...
*/
  ...
  nats is cons of {"englishman";"norwegian";"ukranian";"japanese";"spaniard"};
  
  cigs is cons of {"winston";"lucky-strike";"parliaments";"chesterfield";"kools"};
  
  cols is cons of {"red"; "green"; "blue"; "ivory"; "yellow"};
  
  pets is cons of {"dog"; "zebra"; "snails"; "fox"; "horse"};
  
  drinks is cons of {"coffee"; "water"; "milk"; "tea"; "orange"};
  
  nums is cons of {1;2;3;4;5};
  ...
  removeHouse(_,cons of {}) is cons of {};
  ...
  -- spaniard has dog
  spanConstraint(H,L) where H matches h{nat="none";pet="none"} is 
  ...
  findHouse(N,cons of {H;..L}) where (H matches h{num=M} and N=M) is H;
  ...
  japConstraint(H,L) where H matches h{nat="none";cig="none"} is 
  ...
  luckConstraint(H,L) where H matches h{cig="none";drink="none"} is 
  ...
  foxConstraint(H,L) where H matches h{pet="none"} is 
  -- foxConstraint(H,L) where H matches h{pet="none";num=N} is 
  ...
  chestConstraint(N,L) where (findHouse(N,L) matches h{cig="none";num=M} matching H and M=N)  is 
  ...
  horseConstraint(N,L) where (findHouse(N,L) matches  h{pet="none";num=M} matching H and M=N) is 
  ...
  -- water in some house
  waterConstraint(H,L) where H matches h{drink="none"} is 
  ...
  -- zebra in some house
  zebraConstraint(H,L) where H matches h{pet="none"} is 
  ...
  L1 is cons of {h{nat="norwegian";num=1};h{num=2;col="blue"};h{drink="milk";num=3};h{num=4};h{num=5}};
      	  ...
      	  for (H2 where spanConstraint(H2,L2) matches (L3,true)) in L2 do      	    
    	        ...
    	        -- coffee in green house which has number N4, not house 1 because to right of ivory house
                  ...
                  logMsg(info,"3: Coffee in green house number $N4\n $L4");
 				    ...
 				    {
       	            logMsg(info,"4: Tea by ukrainian\n $L5"); -- tea drunk by ukranian
