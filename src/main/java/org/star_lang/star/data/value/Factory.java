...
/**
 * The Factory has two roles: to support the creation of values and to support
...
public class Factory {
  ...
  /**
   * Construct a wrapped boolean value. Since boolean is essentially an
   * enumeration, this factory function simply returns one of two publicly
   * available instances of BoolWrap.
   *
   * @param trueVal
   *          truth value to wrap
   ...
   * @param i
   *          integer to wrap
   * @return an integer that conforms to the IValue interface, using minimum
   ...
   * <p/>
   * This function distinguishes between @code{null} and non-@code{null} inputs.
   * In the former case, a @code{nonInteger} value is returned. In the latter
   * case, a normal @code{integer} value is returned.
   *
   * @param i
   *          integer to wrap
   ...
   * @param scalar
   *          to unwrap
   * @return the int corresponding to the value. Only numeric scalar values are
   ...
   * @param scalar
   *          to unwrap
   * @return the integer as an @code{Integer}, or null if the input
   *         was @code{nonInteger}
   * @throws EvaluationException
   */
   ...
   * @param i
   *          long value to wrap
   * @return a long that conforms to the IValue interface, using minimum amount
   *         of wrapping paper.
   */
  ...
  /**
   * Return the {@code long} value of a numeric scalar value. to unwrap
   *
   * @param scalar
   *          to unwrap
   * @return the {@code long} corresponding to the value. Only numeric scalar
   *         values are permitted: i.e., integers, longs and floats
   * @throws EvaluationException
   *           if the passed in value is not a number.
   */
   ...
   * <p/>
   * There is only one form of floating point number supported: the equivalent
   * of {@code double}.
   *
   * @param f
   *          number to wrap
   * @return a floating point value that conforms to the IValue interface, using
   ...
   * @param scalar
   *          to unwrap
   * @return the {@code double} corresponding to the value. Only numeric scalar
   *         values are permitted: i.e., integers, longs and floats
   * @throws EvaluationException
   *           if the passed in value is not a number.
   */
   ...
   * @param s
   *          string to wrap
   * @return a string that conforms to the IValue interface, using minimum
   *         amount of wrapping paper.
   */
  ...
  /**
   * Return a new instance of a given type, using the value specifier associated
   * with the label.
   * <p/>
   * The fields in the record are specified as an alternating sequence of string
   * names and values. For example, to construct an instance of {@code someone}
   * one might use:
   * <p/>
   * 
   * <pre>
   ...
   * @param label
   *          the label of the record being constructed. For convenience, this
   *          may be null if and only if there is exactly one value specifier
   *          associated with the type.
   * @param args
   *          the alternating sequence of names and argument values used to
   ...
   *
   * @param elementType
   *          This is a type description handle of the <emph>element</emph> type
   *          of the array, not the description of the array itself.
   * @param elements
   ...
   *
   * @param keyType
   *          The type description appropriate for the type of <emph>keys</emph>
   *          of the map.
   * @param valType
   *          The type description associated with the type of stored
   *          <emph>values</emph> in the map.
   * @param keyValuePairs
   *          An alternating sequence of keys and values that will be used to
   *          provide the initial contents of the map. For example, to create a
   *          map with entries corresponding to "john" and "peter", one might
   *          use:
   *          <p/>
   * 
   *          <pre>
