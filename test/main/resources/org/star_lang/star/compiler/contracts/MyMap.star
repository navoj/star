...
/* measure in definitions of other measures */
  ...
  fingerTreeMeasure(FingerTreeEmpty) is mempty;
...
/** smart constructors */
  ...
  digitMeasure(Digit00) is mempty;
