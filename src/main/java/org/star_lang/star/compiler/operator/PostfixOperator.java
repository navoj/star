...
public class PostfixOperator extends Operator
{
  ...
  public PostfixOperator(String operator, int priority)
  {
    super(operator, priority, OperatorForm.postfix);
  }

  public PostfixOperator(String operator, int priority, OperatorForm form)
  {
    super(operator, priority, form);
  }

  public PostfixOperator(String operator, int priority, int minPriority, OperatorForm form)
  {
  ...
  {
    return "\\tt " + StandardNames.latexString(getOperator()) + "&" + getPriority() + "&postfix";
  }
